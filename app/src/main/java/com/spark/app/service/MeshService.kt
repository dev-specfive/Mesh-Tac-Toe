...
import com.spark.app.repository.datastore.RadioConfigRepository
import com.spark.app.repository.location.LocationRepository
import com.spark.app.repository.network.MQTTRepository
...
class MeshService : Service(), Logging {
    ...
    companion object : Logging {
        ...
        fun createIntent() = Intent().setClassName(
            "com.spark.appa",
            "com.spark.app.service.MeshService"
        )
