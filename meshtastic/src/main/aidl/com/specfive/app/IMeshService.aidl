// com.specfive.app.IMeshService.aidl
...
<queries>
    <package android:name="com.specfive.app" />
</queries>
...
Once you have bound to the service you should register your broadcast receivers per https://developer.android.com/guide/components/broadcasts#context-registered-receivers
    ...
    // com.specfive.app.x broadcast intents, where x is:
    ...
    // (i.e. com.specfive.app.RECEIVED.TEXT_MESSAGE_APP) else the numeric portnum will be included as a base 10 integer (com.specfive.app.RECEIVED.4403 etc...)
