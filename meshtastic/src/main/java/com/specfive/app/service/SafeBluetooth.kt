...
import com.specfive.app.concurrent.CallbackContinuation
import com.specfive.app.concurrent.Continuation
import com.specfive.app.concurrent.SyncContinuation
import com.specfive.app.android.bluetoothManager
...
class SafeBluetooth(private val context: Context, private val device: BluetoothDevice) :
    ...
    private class BluetoothContinuation(
        val tag: String,
        val completion: com.specfive.app.concurrent.Continuation<*>,
     ...
     * 06-29 08:47:15.035 29788-30155/com.specfive.app D/BluetoothGatt: cancelOpen() - device: 24:62:AB:F8:40:9A
    06-29 08:47:15.036 29788-30155/com.specfive.app D/BluetoothGatt: close()
    06-29 08:47:15.037 29788-30155/com.specfive.app D/BluetoothGatt: unregisterApp() - mClientIf=5
    06-29 08:47:15.037 29788-29813/com.specfive.app D/BluetoothGatt: onClientConnectionState() - status=0 clientIf=5 device=24:62:AB:F8:40:9A
    06-29 08:47:15.037 29788-29813/com.specfive.app W/BluetoothGatt: Unhandled exception in callback
    ...
    fun closeGatt() {
        ...
        gatt?.let { g ->
            ...
            try {
                ...
                //com.specfive.app.service.SafeBluetooth.closeGatt
