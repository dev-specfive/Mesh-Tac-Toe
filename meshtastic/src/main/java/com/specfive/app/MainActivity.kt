...
import com.specfive.app.android.*
import com.specfive.app.concurrent.handledLaunch
import com.specfive.app.databinding.ActivityMainBinding
...
import com.specfive.app.service.*
import com.specfive.app.ui.*
import com.specfive.app.util.Exceptions
import com.specfive.app.util.LanguageUtils
import com.specfive.app.util.getPackageInfoCompat
...
//        model.setContactKey(DataPacket.ID_BROADCAST)
   /*     acceptedChannel?.let { channel ->
            model.sendMessage("user_leaves", channel)
        }*/
        super.onDestroy()
    }
